...
/*
Для 2-й set_data можно не копировать все строчку сразу, а просто скопировать весь объект
    void set_data(const Notes &note)
    {
        *this = note;
    }
как бы на месте ЭТОГО указателя, положи объект с такой-то информацией
*/
